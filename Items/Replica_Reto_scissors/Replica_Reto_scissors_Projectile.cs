...
{
    public class Replica_Reto_scissors_Projectile : ModProjectile
    {
		public override string Texture
		{
			get { return "KsonFriends/Items/Replica_Reto_scissors/Replica_Reto_scissors_Projectile"; }
		}

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Replica_Reto_scissors");
		}
