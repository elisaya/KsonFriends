...
{
	public class Demonic_Sieru_flail_Projectile : ModProjectile
	{
		public override string Texture
		{
			get { return "KsonFriends/Items/Demonic_Sieru_flail/Demonic_Sieru_flail_Projectile"; }
		}

		// This file shows an animated projectile
		// This file also shows advanced drawing to center the drawn projectile correctly
		private const string ChainTexturePath = "KsonFriends/Items/Demonic_Sieru_flail/Demonic_Sieru_flail_Projectile_chain"; // The folder path to the flail chain sprite
		private const string ChainTextureExtraPath = "KsonFriends/Items/Demonic_Sieru_flail/Demonic_Sieru_flail_Projectile_chain_extra" +
