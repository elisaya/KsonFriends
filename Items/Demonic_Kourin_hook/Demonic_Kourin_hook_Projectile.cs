...
{
	public class Demonic_Kourin_Hook_Projectile : ModProjectile
	{
		int maximum_hook_number = 2;
		float hook_range = 400f;

		private static Asset<Texture2D> chainTexture;

		public override string Texture
		{
			get { return "KsonFriends/Items/Demonic_Kourin_hook/Demonic_Kourin_Hook_Projectile"; }
		}

		public override void Load()
		{ // This is called once on mod (re)load when this piece of content is being loaded.
		  // This is the path to the texture that we'll use for the hook's chain. Make sure to update it.
			chainTexture = ModContent.Request<Texture2D>("KsonFriends/Items/Demonic_Kourin_hook/Demonic_Kourin_hook_Chain");
		}
