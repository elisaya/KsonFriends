...
{
    public class Demonic_Reto_scissors : ModItem
    {
		int weapon_level;
		int[] exp_req = { 200, 750, 1350, 2500, 6000, 10000 };

		SlotId? sfxSlot;
		SoundStyle scissors_SFX = new SoundStyle("KsonFriends/Items/Demonic_Reto_scissors/Reto_scissors_SFX") { IsLooped = true, SoundLimitBehavior = SoundLimitBehavior.IgnoreNew };

		public override string Texture
		{
			get { return "KsonFriends/Items/Demonic_Reto_scissors/Demonic_Reto_scissors"; }
		}

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("[Demonic] Divine Auto-guided Scissors");
			Tooltip.SetDefault("Megami power infused with demonic power. Chaos is taking over."
				+ Environment.NewLine + "Infamously known as \"Destroyer of all Achilles' tendons\", never missed once."
		...
		public override void SetDefaults()
		{
			...
			Item.useTurn = true;
			Item.shoot = ModContent.ProjectileType<Demonic_Reto_scissors_Projectile>();
			Item.shootSpeed = 21;
			Item.mana = 60;
			Item.holdStyle = 3;
			Item.noMelee = true;
		...
		public override void AddRecipes()
		{
			...
			Recipe Demonic_Reto_scissors_recipe = CreateRecipe(1);
			Demonic_Reto_scissors_recipe.AddRecipeGroup(demonicore, 14);
			Demonic_Reto_scissors_recipe.AddRecipeGroup(demonicbossdrop, 12);
			Demonic_Reto_scissors_recipe.AddIngredient(ModContent.ItemType<Replica_Reto_scissors>());
			Demonic_Reto_scissors_recipe.AddTile(TileID.WorkBenches);
			Demonic_Reto_scissors_recipe.Register();
