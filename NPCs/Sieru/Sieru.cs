...
{
	[AutoloadHead]
	public class Sieru : ModNPC
	{
		public override string Texture {
			get {return "KsonFriends/NPCs/Sieru/Sieru"; }
		}

		public override void SetStaticDefaults()
        {
			DisplayName.SetDefault("Yashiki Ciel");
		...
		public override string GetChat()
		{
			...
			chat.Add("Kon-yashiki~ Can you hear me? Yashiki Ciel desu~");
