...
{
	[AutoloadHead]
	public class Hana : ModNPC
	{
		public override string Texture {
			get {return "KsonFriends/NPCs/Hana/Hana"; }
		}

		public override void SetStaticDefaults()
        {
			DisplayName.SetDefault("Kokorone Hana");
		...
		public override string GetChat()
		{
			...
			chat.Add("Isebui Gen 1, elf of Dandelions, Kokorone Hana de-su~");
