...
{
	[AutoloadHead]
	public class Yaman : ModNPC
	{
		public override string Texture {
			get {return "KsonFriends/NPCs/Yaman/Yaman"; }
		}

		public override void SetStaticDefaults()
        {
			DisplayName.SetDefault("Yaman**");
		...
		public override string GetChat()
		{
			...
			chat.Add("I am Kson's body & Tokkoufuku designer, Yaman.");
			chat.Add("Who the heck are you?! I'm doing APEX Legends!!");
			chat.Add("II KAGEN NI SEI");
			chat.Add("I'm a dude, so of course no one ever called me.");
