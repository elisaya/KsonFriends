...
{
	[AutoloadHead]
	public class Reto : ModNPC
	{
		public override string Texture {
			get {return "KsonFriends/NPCs/Reto/Reto"; }
		}

		public override void SetStaticDefaults()
        {
			DisplayName.SetDefault("Kamikurai Leto");
		...
		public override string GetChat()
		{
			...
			chat.Add("Leto ne....");
			chat.Add("omocya no cya cya cya ~~");
			chat.Add("Kimi no kawaii Akiresu-ken....");
			chat.Add("wwrryy.... arururu.... haurururu.... megami can't roll her tongue....");
