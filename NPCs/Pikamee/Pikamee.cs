...
{
	[AutoloadHead]
	public class Pikamee : ModNPC
	{
		public override string Texture {
			get {return "KsonFriends/NPCs/Pikamee/Pikamee"; }
		}

		public override void SetStaticDefaults()
        {
			DisplayName.SetDefault("Amane Pikamee");
		...
		public override string GetChat()
		{
			...
			chat.Add("PIYAAAA-----");
			chat.Add("It me dayo!");
			chat.Add("Lets kill da hoe!");
			chat.Add("\"Thank you so much for all the support. We are doing great!\"", 0.2);
