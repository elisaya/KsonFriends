...
{
	[AutoloadHead]
	public class Tomari : ModNPC
	{
		public override string Texture {
			get {return "KsonFriends/NPCs/Tomari/Tomari"; }
		}

		public override void SetStaticDefaults()
        {
			DisplayName.SetDefault("Tomari Mari");
		...
		public override string GetChat()
		{
			...
			chat.Add("Minna-sama~ Konbanwa de Gozaimasu~ Tomari Mari desu~");
