...
{
	[AutoloadHead]
	public class Taishi : ModNPC
	{
		public override string Texture {
			get {return "KsonFriends/NPCs/Taishi/Taishi"; }
		}

		public override void SetStaticDefaults()
        {
			DisplayName.SetDefault("Kamishiro Taishi");
		...
		public override string GetChat()
		{
			...
			chat.Add("'Ello~ Konnichiwa~ Loud and clear?");
			chat.Add("ANUSU APPROVED???! THE ANUSU IS NOT APPROVING JACK SH!T!!!!!??");
