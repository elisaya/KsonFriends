...
{
	[AutoloadHead]
	public class Hanaoka : ModNPC
	{
		public override string Texture {
			get {return "KsonFriends/NPCs/Hanaoka/Hanaoka"; }
		}

		public override void SetStaticDefaults()
        {
			DisplayName.SetDefault("Hanaoka Momo");
		...
		public override string GetChat()
		{
			...
			chat.Add("Hanaoka dayo~~~ Hanaoka dayo~~~ Hanaoka dayo~~~ (ECHO)");
