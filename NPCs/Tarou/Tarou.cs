...
{
	[AutoloadHead]
	public class Tarou : ModNPC
	{
		public override string Texture {
			get {return "KsonFriends/NPCs/Tarou/Tarou"; }
		}

		public override void SetStaticDefaults()
        {
			DisplayName.SetDefault("Tarou");
		...
		public override string GetChat()
		{
			...
			chat.Add("Zenka Sanpan! 893-ban Choueki Tarou desu.");
			chat.Add("Face time over!");
